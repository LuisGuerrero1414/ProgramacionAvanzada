...
public class VInventario extends JInternalFrame {
    ...
    public JButton btnEliminar, btnExcelGral, btnExcelCat, btnLimpiar;
    ...
    public VInventario() {
        ...
        cbTipo = new JComboBox<>(new String[]{"--- Seleccionar ---", "Abarrotes", "Bebidas", "Carnes y Pescados", "Frutas y Verduras", "Lácteos y Huevo", "Mascotas", "Limpieza del Hogar", "Cuidado Personal", "Panadería y Tortillería", "Salchichonería", "Snacks y Dulcería"});
