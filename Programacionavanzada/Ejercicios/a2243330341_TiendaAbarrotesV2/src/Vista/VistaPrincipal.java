...
public class VistaPrincipal extends JFrame {
    ...
    public JMenuItem itemInventario, itemPuntoVenta, itemProductos, itemProveedores, itemUnidades;
    ...
    public VistaPrincipal() {
        ...
        itemProveedores = new JMenuItem("4. Proveedores");
        itemUnidades = new JMenuItem("5. Unidades de Medida");

        // Estilo para los items del menú
        JMenuItem[] items = {itemInventario, itemPuntoVenta, itemProductos, itemProveedores, itemUnidades};
        ...
        menuModulos.add(itemProveedores);
        menuModulos.add(itemUnidades);
